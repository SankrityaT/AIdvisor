...
const cols = [
  {
    title: "Product",
    links: [
      { label: "What Sol handles", href: "#handles" },
      { label: "How it works", href: "#how" },
      { label: "Why trust Sol", href: "#trust" },
    ...
    <footer className="footer">
      <div className="wrap">
        ...
        <div className="foot-bottom">
          <span>
            © 2026 Sol · a concept project, not affiliated with Arizona State
            University.
          </span>
          <span className="disc">
            Sol is an AI assistant. For urgent matters, medical needs, or
